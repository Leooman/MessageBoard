...
(function(){
    ...
    UM.registerWidget( widgetName,{
        ...
        createPreviewVideo: function(url){
            ...
            if(!me.endWith(conUrl,[".mp4",".swf",".flv",".wmv"])){
...
*/
$("#eduiVideoPreview", me.$widget)[0].innerHTML = '<video width=420 height=280 controls="" autoplay="" name="media"><source src="'+url+'" type="video/mp4"></video>';
